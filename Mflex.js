...
async function main() {
    const movies = await fetch("https://api.themoviedb.org/3/trending/all/day?api_key=59a2cc2fa5db4670eabfee80c179fa9a")
...
function moviesTrend(movie) {
    ...
    <div class="movie__description"> 
     ...
     <h4 class="movie__year" class="text-color1">${movie.release_date}</h4>
    </div>
