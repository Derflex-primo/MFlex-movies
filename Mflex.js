(function () {
    ...
    function scrollToSection() {
      const mySection = document.querySelector(".Mflexmovie");
      const sectionOffsetTop = mySection.offsetTop;
      const scrollToPosition = sectionOffsetTop - 20; // Adjust scroll position as needed
